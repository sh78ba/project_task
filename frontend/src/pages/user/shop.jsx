  ...
  return (  
    <>
      <Helmet>
        ...
        <meta name="keywords" content="Books, Gift Boxes, Stationery"/>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {categories.map((category, index) => (
              <motion.div
                key={index}
                className={`bg-white rounded-xl p-5 shadow-lg overflow-hidden transform transition-all duration-300 
              ...
              >
                <div 
                  className="h-56 bg-cover rounded-xl bg-center transition-transform duration-300 transform hover:scale-110"
                ...
                >
                  ...
                  >
                    <img
                      src={product.img}
                      alt={product.name}
                      className=" inset-0 p-3 rounded-t-xl w-full h-full object-cover group-hover:scale-105 transition-transform"
                    />
                    {}
