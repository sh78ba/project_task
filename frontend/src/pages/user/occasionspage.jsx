...
export default function OccasionsPage() {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="Discover unique gifts and thoughtful collections by occassion." />
      <meta name="keywords" content="Birthdays, Weddings, Holidays, Anniversaries, Parties, Dinner Events, Graduations"/>
    </Helmet>
      <Navbar />
          ...
          <div className="grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredOccasions.map((occasion) => (
              <OccasionCard
                ...
                Icon={occasion.Icon}
                className="transform cursor-pointer transition duration-500 hover:scale-105 hover:shadow-2xl animate-float"
              />
            ))}
          </div>
        </div>
